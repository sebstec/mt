...
\begin{lstlisting}[style=basicStyle, language=Python, caption=function constructor bypass payload using square bracket notation, label={lst:funconbypasssbn}]
[]['constructor']['constructor'](`var/**/s/**/=/**/'secret';/**/promp`/**/+/**/`t(s,/**/s)`)()
\end{lstlisting}
...
\begin{lstlisting}[style=basicStyle, caption=function constructor bypass payload using dot notation, language=Python]
[].constructor.constructor(`var/**/s/**/=/**/'secret';/**/promp`/**/+/**/`t(s,/**/s)`)()
\end{lstlisting}
...
\begin{lstlisting}[style=ruleStyle, language=XML, caption=stored XSS blocked, label={lst:storedxssblocked}]
