...
Calling \verb|.normalize('NFKD')| on the bypassed string: \verb|"alert\u{207D}'normalizeMe')".normalize('NFKD')| will convert the string to the original payload: \verb|"alert('normalizeMe')"|.
